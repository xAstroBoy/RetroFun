    ...
    public partial class PetPage:  ObservablePage
    {
        ...
        public override void Out_CatalogBuyItem(DataInterceptedEventArgs e)
        {
            ...
            if(isInterceptEnabled)
            {
                ...
                e.IsBlocked = true;
                SendToClient(In.RoomUserWhisper, 0, "[Pet Editor]: Values intercepted, see Retrofun.", 0, 34, 0, -1);
        ...
        private void InterceptPetPurchaseBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SendToClient(In.RoomUserWhisper, 0, "[Pet Editor]: Please purchase The Pet to load the values to edit with Retrofun", 0, 34, 0, -1);
